...
var tags=["etiqueta para usar negrita html","quien regula las normas de la web?","Etiqueta para enlazar archivos"];
var answers1=["MWI","MXN0cm9uZw","MGM","MHY","MG4","MGE"];
var answers2=["MVczQw","MFczU0NIT09PTFM","MFMyVw","MFMy","MDNX"];
var answers3=["MWxpbms","MGxvbms","MG5vbA","MGxlbms"];
var ans=[answers1,answers2,answers3];
var err=["que mal","sigue intentando","practica mas"];
var ima=["","",""];
var mp4=["","",""];
var ogv=["","",""];
